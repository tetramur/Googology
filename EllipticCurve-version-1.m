...
(*DetailedTateCond[p_]:=*)
(*Which[Mod[Delta,p]!=0,0,*)
(*Mod[Delta,p]==0&&Mod[c4,p]!=0,1,*)
(*Mod[newa6[TateChange1[p]],p^2]!=0,v[p],*)
(*Mod[newb8[TateChange1[p]],p^3]!=0,v[p]-1,*)
(*Mod[newb6[TateChange1[p]],p^3]!=0,v[p]-2,*)
(*TripleDistinctQ[AuxTatePolynomialS1[p]],v[p]-4,*)
(*TripleDoubleQ[AuxTatePolynomialS1[p]],v[p]-4-nu,*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&AuxTatePolynomialS2[p]===Y,v[p]-6,*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&PairDistinctQ[AuxTatePolynomialS2[p]],v[p]-6,*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&!(PairDistinctQ[AuxTatePolynomialS2[p]])&&*)
(*Mod[newa4[AuxTatePolynomialC2[p]],p^4]!=0,v[p]-7,*)
(*Mod[Coefficient[Expand[AuxTatePolynomial2[p]/.Y->(Y+AuxTatePolynomialS2[p][[1]])],Y,0]*p^4,p^6]!=0,v[p]-8,*)
(*True,NotMinimal]*)
(**)
(*TamagavaIndex[p_]:=*)
(*Which[Mod[Delta,p]!=0,1,*)
(*Mod[Delta,p]==0&&Mod[c4,p]!=0,v[p],*)
(*Mod[newa6[TateChange1[p]],p^2]!=0,1,*)
(*Mod[newb8[TateChange1[p]],p^3]!=0,2,*)
(*Mod[newb6[TateChange1[p]],p^3]!=0,Maybe[3,1],*)
(*TripleDistinctQ[AuxTatePolynomialS1[p]],Maybe[4,2],*)
(*TripleDoubleQ[AuxTatePolynomialS1[p]],Maybe[4,2],*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&AuxTatePolynomialS2[p]===Y,1,*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&PairDistinctQ[AuxTatePolynomialS2[p]],3,*)
(*TripleEqualQ[AuxTatePolynomialS1[p]]&&!(PairDistinctQ[AuxTatePolynomialS2[p]])&&*)
(*Mod[newa4[AuxTatePolynomialC2[p]],p^4]!=0,2,*)
(*Mod[Coefficient[Expand[AuxTatePolynomial2[p]/.Y->(Y+AuxTatePolynomialS2[p][[1]])],Y,0]*p^4,p^6]!=0,1,*)
(*True,NotMinimal]*)
(**)
(*A:=Sqrt[Conductor]/(2Pi)*)
(**)
(*Terms[n_]:=Apply[Times,CoeffsL[Delete[#,0]]&/@FactorInteger[n]]*)
(**)
(*FactorL[s_]:=AnL[s]/(2*A^s*Gamma[s])*)
(**)
(*G[s_,t_]:=2*t^(-s)*Gamma[s,t]*)
